...
export class ProjectTemplateManager {
   ...
   * 基础HTML模板
   */
  private getBasicIndexHtml = (config: Partial<AppConfig>): string => {
...
<body>
   ...
   * 基础README模板
   */
  private getBasicReadme = (config: Partial<AppConfig>): string => {
    const appName = config.appName || 'My Web App';
...
`;
   ...
   * React HTML模板
   */
  private getReactIndexHtml = (config: Partial<AppConfig>): string => {
...
<body>
   ...
   * React App组件模板
   */
  private getReactApp = (config: Partial<AppConfig>): string => {
    const appName = config.appName || 'My React App';
