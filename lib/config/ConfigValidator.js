...
export class ConfigValidator {
    constructor() {
        this.VALID_ORIENTATIONS = ['portrait', 'landscape', 'any'];
        this.PACKAGE_NAME_REGEX = /^[a-z][a-z0-9_]*(\.[a-z][a-z0-9_]*)+$/;
        this.VERSION_REGEX = /^\d+\.\d+\.\d+$/;
    }
    /**
     ...
     */
    validateFieldFormats(config, errors, warnings) {
        // Validate app name
     ...
     */
    validatePermissions(config, warnings) {
        ...
        const hasNetworkStatePermission = config.permissions.includes('android.permission.ACCESS_NETWORK_STATE');
